...
<div class="container mt-10">
    ...
    <div class="row align-items-md-center content-space-2 content-space-b-lg-2">
        <div class="col-md-6 order-md-2 mb-10 mb-md-0 text-center offset-3" >
            <h2 class="h1 lh-sm">Page Not Found!</h2>
            <p>Looks like we couldn't find that page. Please try again or contact our technical support staff if the problem persists.</p>
            <div class="mt-10">
